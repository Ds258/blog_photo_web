                ...
                <footer class="py-5">
                    <div class="row">
                        <div class="col-6 col-md-2 mb-3">
                            ...
                            <ul style={{ color: "white" }} class="nav flex-column">
                                <li class="nav-item mb-2">About us</li>
                                <li class="nav-item mb-2">Join us</li>
                                <li class="nav-item mb-2">Contacts us</li>
                            </ul>
                        </div>
                        <div class="col-6 col-md-2 mb-3">
                            <h5 style={{ color: "white" }}>Categories</h5>
                            <ul style={{ color: "white" }} class="nav flex-column">
                                <li class="nav-item mb-2">What's new</li>
                                <li class="nav-item mb-2">Discovery</li>
