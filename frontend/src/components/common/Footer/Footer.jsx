                ...
                <footer className="py-5">
                    <div className="row">
                        <div className="col-6 col-md-2 mb-3">
                            ...
                            <ul style={{ color: "white" }} className="nav flex-column">
                                <li className="nav-item mb-2">About us</li>
                                <li className="nav-item mb-2">Join us</li>
                                <li className="nav-item mb-2">Contacts us</li>
                            </ul>
                        </div>
                        <div className="col-6 col-md-2 mb-3">
                            <h5 style={{ color: "white" }}>Categories</h5>
                            <ul style={{ color: "white" }} className="nav flex-column">
                                <li className="nav-item mb-2">What's new</li>
                                <li className="nav-item mb-2">Discovery</li>
